...
namespace AwtrixHub.Functions.Tests.Services
{
    public class MqttServiceTests
    {
        ...
        //[Test, Description("PublishAsync publishes message to server")]
        ...
        //[Test, Description("PublishAsync throws when broker not available")]
